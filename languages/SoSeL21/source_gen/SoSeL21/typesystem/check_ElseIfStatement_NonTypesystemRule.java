...
public class check_ElseIfStatement_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public check_ElseIfStatement_NonTypesystemRule() {
  }
  public void applyRule(final SNode e, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (SNodeOperations.getConcept(e).getConceptAlias() == "elseif") {
      if (!(SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(SNodeOperations.getConcept(SLinkOperations.getTarget(e, LINKS.cond$KSaJ))), CONCEPTS.BinaryComparisonExpression$JG))) {
        {
          final MessageTarget errorTarget = new NodeMessageTarget();
          IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(e, "Not a valid condition ", "r:69300e82-0e15-404d-87f2-8e5784afc430(SoSeL21.typesystem)", "7316402585416830372", null, errorTarget);
        }
      }
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.ElseIfStatement$8X;
  }
