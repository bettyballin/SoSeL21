...
public class GrammarCellsSubstituteMenu_ElseIfStatement extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ElseIfStatement() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_b0qroe_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ElseIfStatement", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_b0qroe_a extends GrammarCellsSubstituteMenuPart {
    @Override
