...
public class GrammarCellsSubstituteMenu_IElseStatement extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IElseStatement() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_7jra5w_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IElseStatement", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_7jra5w_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.IElseStatement$sy;
    }
  }
